...
CONFIG_NAME=w2vu.yaml
TASK_DATA=/home/015910674/projects/speech_features_v1/precompute_pca512_cls128_mean_pooled

# Unpaired text input
TEXT_DATA=/home/015910674/projects/ua_speech_text_data/text_features/phones  # path to fairseq-preprocessed GAN data (phones dir)
KENLM_PATH=/home/015910674/projects/ua_speech_text_data/text_features/phones/lm.phones.filtered.04.bin # KenLM 4-gram phoneme language model (LM data = GAN data here)
