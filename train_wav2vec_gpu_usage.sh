...
TASK_DATA=/home/015910674/projects/step_6
...
# Unpaired text input
TEXT_DATA=/home/015910674/projects/text_data/phones  # path to fairseq-preprocessed GAN data (phones dir)
KENLM_PATH=/home/015910674/projects/text_data/phones/lm.phones.filtered.04.bin # KenLM 4-gram phoneme language model (LM data = GAN data here)

# Start GPU monitoring in background
# nvidia-smi --query-gpu=utilization.gpu,utilization.memory,temperature.gpu --format=csv -l 1 >> job.log &
...
# Stop GPU monitoring
# kill $(ps aux | grep 'nvidia-smi' | awk '{print $2}')
